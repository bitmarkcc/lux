...
enum class CertimarkStatus {
    ...
    SIGNED_TRUSTED,  // Cert is signed by a user-trusted signing key
    TRUSTED          // Cert explicitly trusted by user
}
...
data class CertEntry(
    ...
    val weight: Long,
    val certUrl: String?,
    val signerPubkeys: List<String> = emptyList()
)
...
data class CertimarkResult(
    ...
    val trustedSignerKey: String? = null
)
